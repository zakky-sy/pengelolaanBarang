                    ...
                    <div class="form-group col-md">
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="nama" placeholder="Masukkan Nama petugas" autocomplete="off"  class="form-control"  value="<?= $petugas->nama ?>">
                      ...
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" name="password" placeholder="Masukkan Password" autocomplete="off"  class="form-control"  value="<?= $petugas->password ?>" readonly>
