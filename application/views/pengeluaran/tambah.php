								...
								<form action="<?= base_url('pengeluaran/proses_tambah') ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-3">
											...
											<input type="text" name="kode_petugas" value="<?= $profil['kode'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-3">
											<label>Nama Petugas</label>
											<input type="text" name="nama_petugas" value="<?= $profil['nama'] ?>" readonly class="form-control">
										</div>
										<div class="form-group col-2">
