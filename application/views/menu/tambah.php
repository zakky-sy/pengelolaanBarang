				...
				<div class="row">
					<div class="col-md-3">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('menu/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md">
											<label for="menu"><strong>Menu</strong></label>
											<input type="text" name="menu" placeholder="Masukkan Menu" autocomplete="off"  class="form-control" >
