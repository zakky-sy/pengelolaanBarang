				...
				<div class="row">
					<div class="col-md-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form action="<?= base_url('submenu/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="submenu"><strong>Sub Menu</strong></label>
											<input type="text" name="submenu" placeholder="Masukkan nama Sub Menu" autocomplete="off"  class="form-control" value="<?= set_value('submenu') ?>">
                      ...
                      <?= form_error('menu', '<small class="text-danger pl-1">', '</small>'); ?>
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="url" placeholder="Masukkan Url Sub Menu" autocomplete="off"  class="form-control" value="<?= set_value('url'); ?>">
                      <?= form_error('url', '<small class="text-danger pl-1">', '</small>'); ?>
										</div>
										<div class="form-group col-md-6">
											<label for="ikon"><strong>Ikon</strong></label>
											<input type="text" name="ikon" placeholder="Masukkan Ikon" autocomplete="off"  class="form-control" value="<?= set_value('ikon'); ?>">
